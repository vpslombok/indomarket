...
class Menu extends CI_Controller
{
    ...
    public function index()
    {
        ...
        $this->form_validation->set_rules('menu', 'Menu', 'required', ['required' => 'Menu Harus Diisi']);
    ...
    public function submenu()
    {
        ...
        $this->session->set_flashdata('submenu', '<div class="alert alert-success" role="alert">New Menu Added!</div>');
    ...
    public function editsubmenu($id)
    {
        ...
        $this->session->set_flashdata('edit submenu', '<div class="alert alert-success" role="alert">menu berhasil di edit!</div>');
        redirect('menu/submenu');
        }
    }
    ...
    public function deleteSubmenu($id)
    {
        ...
        $this->session->set_flashdata('submenu', '<div class="alert alert-success" role="alert">Submenu Deleted!</div>');
        redirect('menu/submenu');
    }
